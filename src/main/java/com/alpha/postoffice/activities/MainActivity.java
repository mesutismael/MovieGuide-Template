package com.alpha.postoffice.activities;
...
import com.alpha.postoffice.fragments.MoviesFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.this.getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.content_frame, MoviesFragment.newInstance(null,null))
                .commit();
    }
